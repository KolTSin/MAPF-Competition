...
struct CellInfo {
    bool is_corner{false};                      // Blocking should be somewhat costly
    bool is_three_way_intersection{false};      // Blocking should be very costly
    bool is_four_way_intersection{false};       // Blocking should be very costly
    bool is_intersection{false};                // Can either be a three or four way intersection
    int blocked_diagonals{0};                   // How difficult is the cell to navigate around
